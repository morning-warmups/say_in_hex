...
puts "=================Expected Output Test================="
puts ["0x", 'F5', " ", createSentence('0xF5')].join
puts ["0x", 'B3', " ", createSentence('0xB3')].join
puts ["0x", 'E4', " ", createSentence('0xE4')].join
puts ["0x", 'BBBB', " ", createSentence('0xBBBB')].join
puts ["0x", 'A0C9', " ", createSentence('0xA0C9')].join
puts "======================================================"
